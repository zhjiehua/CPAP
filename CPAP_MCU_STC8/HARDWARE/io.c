...
const char OXYGEN_MODE_STRING[] = {0x43, 0x50, 0x41, 0x50, 0xC4, 0xA3, 0xCA, 0xBD}; //CPAP模式
const char RHINOBYON_MODE_STRING[] = {0xB8, 0xDF, 0xC1, 0xF7, 0xC1, 0xBF}; //高流量模式
const char CAPA_MODE_STRING[] = {0x43, 0x50, 0x41, 0x50, 0xC4, 0xA3, 0xCA, 0xBD}; //CPAP模式
...
void IO_Init(void)
{
	...
	//----------------------
	P4M1 = 0x00;    //双双双双双双推双双        //LCD_RXD改成推挽
	P4M0 = 0x04;
